...
using GS.SISGEGS.WINContado.OrdenVentaWCF;
using GS.SISGEGS.WINContado.AgendaWCF;
using GS.SISGEGS.WINContado.ImpuestoWCF;
using GS.SISGEGS.WINContado.ItemWCF;


namespace GS.SISGEGS.WINContado
{
    class Program
    {
