<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmProductoCliente.aspx.cs" Inherits="GS.SISGEGS.Web.Management.Management.Producto.frmProductoCliente" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <telerik:RadWindowManager ID="rwmProducto" runat="server" EnableShadow="true">
        <Windows>
            <telerik:RadWindow ID="rwProducto" runat="server" Width="400px" Height="400px" ReloadOnShow="true"
                        ...
                        <telerik:RadGrid ID="grdProducto" runat="server" Width="100%" Height="525px" AutoGenerateColumns="false" AllowSorting="false"
                            ...
                            <MasterTableView Width="100%" DataKeyNames="ID" ClientDataKeyNames="ID">
                                <Columns>
                                    ...
                                    <telerik:GridButtonColumn ConfirmText="¿Desea eliminar el producto por cliente?" ConfirmDialogType="RadWindow" HeaderStyle-Width="30px" HeaderText="Elim."
