<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPopUpS.Master" AutoEventWireup="true" CodeBehind="frmProductoClienteMng.aspx.cs" Inherits="GS.SISGEGS.Web.Management.Management.Producto.frmProductoClienteMng" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <telerik:RadAjaxPanel ID="rapProductoMng" runat="server" Width="100%">
        ...
        <div class="fila">
            ...
            <div class="colum3">
                <telerik:RadNumericTextBox ID="txtPrecEspecial" runat="server" Width="100%"></telerik:RadNumericTextBox>
            </div>
            <div class="colum5">
