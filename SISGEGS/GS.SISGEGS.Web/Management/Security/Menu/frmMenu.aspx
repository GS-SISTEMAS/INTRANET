<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmMenu.aspx.cs" Inherits="GS.SISGEGS.Web.Management.Security.Menu.frmMenu" %>
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <telerik:RadButton ID="btnGuardar" runat="server" Text="Guardar" Visible="false">
