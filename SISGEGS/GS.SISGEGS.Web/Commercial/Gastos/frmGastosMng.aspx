<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPopUpMX.Master" AutoEventWireup="true" CodeBehind="frmGastosMng.aspx.cs" Inherits="GS.SISGEGS.Web.Commercial.Gastos.frmGastosMng" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <telerik:RadWindowManager ID="rwmGastosMng" runat="server" EnableShadow="true">
        <Windows>
            <telerik:RadWindow ID="rwGastosMng" runat="server" Width="400px" Height="400px" ReloadOnShow="true"
    ...
    <telerik:RadAjaxPanel ID="rapGastosMng" runat="server" Width="100%">
        ...
        <div class="fila">
            <div class="colum3">
                <div class="colum3">
                    <asp:Label ID="lblFechaReg" runat="server" Text="Fecha" CssClass="etiqueta"></asp:Label>
                </div>
                <div class="colum7">
                    <telerik:RadDatePicker ID="dpFecRegistro" runat="server" Width="100%" DateInput-ReadOnly="true">
            ...
            <div class="colum3">
                <div class="colum3">
                    <asp:Label ID="lblFechaVcmt" runat="server" Text="Vencim." CssClass="etiqueta">
                    </asp:Label>
                </div>
                <div class="colum7">
                    <telerik:RadDatePicker ID="dpFecVencimiento" runat="server" Width="100%" DateInput-ReadOnly="true" >
                        <DateInput runat="server" DateFormat="dd/MM/yyyy">
                        </DateInput>
                    </telerik:RadDatePicker>
                </div>
