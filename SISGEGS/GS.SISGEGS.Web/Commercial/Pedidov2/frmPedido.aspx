<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmPedido.aspx.cs" Inherits="GS.SISGEGS.Web.Commercial.Pedidov2.frmPedido" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function ShowEditForm(id, rowIndex) {
            var grid = $find("<%= grdOrdenVenta.ClientID %>");
    ...
    <telerik:RadAjaxPanel ID="pnlPedido" runat="server">
        ...
        <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Height="500px"
            ...
            <telerik:RadPane ID="RadPane2" CssClass="contentPaneDecorator" runat="server" Width="100%" Scrolling="None">
                <div class="row">
                    <div class="col-md-12">
                        <telerik:RadGrid RenderMode="Lightweight" ID="grdOrdenVenta" Width="100%" DataSourceID="SqlDataSource1" AllowFilteringByColumn="True"
