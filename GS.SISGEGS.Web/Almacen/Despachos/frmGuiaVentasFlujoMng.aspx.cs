...
{
    public partial class frmGuiaVentasFlujoMng : System.Web.UI.Page
    {
        ...
        //private void GuiaVentasFlujo_Cargar(int idOperacion)
        //{
        //    GuiaWCFClient objGuiaVentasFlujoWCF = new GuiaWCFClient();

        //    gsGuiaVenta_ListarxOPResult[] objGuiaVentasFlujoCab;

        //    try
        //    {
        //        Session["Id_Transporte"] = null;

        //        objGuiaVentasFlujoCab = objGuiaVentasFlujoWCF.GuiaVenta_ListarxOP(((Usuario_LoginResult)Session["Usuario"]).idEmpresa,
        //            ((Usuario_LoginResult)Session["Usuario"]).codigoUsuario, idOperacion);

        //        lblCodigoCliente.Value = objGuiaVentasFlujoCab[0].id_agenda;
        //        lblCodigoOrigen.Value = objGuiaVentasFlujoCab[0].DireccionOrigenAgenda;
        //        lblCodigoDestino.Value = objGuiaVentasFlujoCab[0].DireccionDestinoAgenda;
        //        lblCodigoTransportista.Value = objGuiaVentasFlujoCab[0].ID_Transportista;
        ...
        //        txtIDChofer.Text = objGuiaVentasFlujoCab[0].ID_Chofer.ToString();
        //        txtChofer.Text =  objGuiaVentasFlujoCab[0].TransportistaChofer.ToString();
        //        txtLicencia.Text = objGuiaVentasFlujoCab[0].TransportistaLicencia.ToString();

        //        txtVehiculoPlaca.Text = objGuiaVentasFlujoCab[0].ID_Vehiculo.ToString();
        //        txtVehiculoMarca.Text = objGuiaVentasFlujoCab[0].TransportistaMarca.ToString();
        //        txtVehiculoModelo.Text = objGuiaVentasFlujoCab[0].TransportistaModelo.ToString();
        //        txtCertificado.Text = objGuiaVentasFlujoCab[0].TransportistaCertInscripcion.ToString();

        //        cboFacturacionCliente.SelectedValue = objGuiaVentasFlujoCab[0].ID_AgendaDireccion.ToString();
        //        cboDespacho.SelectedValue = objGuiaVentasFlujoCab[0].ID_AgendaDireccion2.ToString();

        //        cboFacturacionOrigen.SelectedValue = objGuiaVentasFlujoCab[0].DireccionOrigenDireccion.ToString();
        //        cboSucursalOrigen.SelectedValue = objGuiaVentasFlujoCab[0].DireccionOrigenSucursal.ToString();
        //        cboReferenciaOrigen.SelectedValue = objGuiaVentasFlujoCab[0].DireccionOrigenReferencia.ToString();

        //        cboFacturacionDestino.SelectedValue = objGuiaVentasFlujoCab[0].DireccionDestinoDireccion.ToString();
        //        cboSucursalDestino.SelectedValue = objGuiaVentasFlujoCab[0].DireccionDestinoSucursal.ToString();
        //        cboReferenciaDestino.SelectedValue = objGuiaVentasFlujoCab[0].DireccionDestinoReferencia.ToString();

        //        //------------------------------------
        //        dpFechaDespacho.SelectedDate = objGuiaVentasFlujoCab[0].FechaDespacho;
        //        dpFechaTraslado.SelectedDate = objGuiaVentasFlujoCab[0].FechaTraslado;
        //        dpFechaEmision.SelectedDate = objGuiaVentasFlujoCab[0].FechaEmision;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    //GuiaVentasFlujo_Cargar(int.Parse((Request.QueryString["idOperacion"])));
        ...
        protected void ramGuiaVentasFlujoMng_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            if (Session["Usuario"] == null)
                ScriptManager.RegisterStartupScript(Page, this.GetType(), "mykey", "CancelEdit();", true);
            try
            {
                if (e.Argument == "Rebind")
                {
                    ...
                    lblMensaje.Text = "Se agregó el producto al GuiaVentasFlujo.";
                    lblMensaje.CssClass = "mensajeExito";
                ...
                if (e.Argument.Split('(')[0].Trim() == "RebindAndNavigate")
                {
                    ...
                    lblMensaje.Text = "Se agregó el producto con nro. kardex " + e.Argument.Split('(')[1].Trim().Split(')')[0] + " al GuiaVentasFlujo.";
                    lblMensaje.CssClass = "mensajeExito";
