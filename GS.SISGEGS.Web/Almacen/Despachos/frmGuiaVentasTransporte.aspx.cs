...
{
    public partial class frmGuiaVentasTransporte : System.Web.UI.Page
    {
        ...
        private void ListarGuiasVentas(string codAgenda,  DateTime fechaInicial, DateTime fechaFinal, string id_item, int id_almacen , int id_vehiculo)
        {
            ...
            try
            {
                List<gsGuiaVentas_TransitolistarResult> lst = objGuiaWCF.GuiaVenta_TransitoListar(((Usuario_LoginResult)Session["Usuario"]).idEmpresa, ((Usuario_LoginResult)Session["Usuario"]).codigoUsuario, codAgenda,  fechaInicial, fechaFinal, id_item, id_almacen, 0, id_vehiculo).ToList();
        ...
        private void BuscarFechas_ListarGuiasVentas()
        {
            ...
            try
            {
                if (Validar_Variables() == 0)
                {
                    ...
                    ListarGuiasVentas(cliente, fecha1, fecha2, item, almacen, vehiculo);
                }
        ...
        protected void cboTransporte_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            ...
            {
                btnRegistrarFecha.Enabled = true;
