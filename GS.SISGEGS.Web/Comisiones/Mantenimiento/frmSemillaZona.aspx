<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmSemillaZona.aspx.cs" Inherits="GS.SISGEGS.Web.Comision.Mantenimiento.frmSemillaZona" %>
             ...
             <div class="row">
                ...
                <div class="col-md-6">
                 <telerik:RadGrid ID="grdZonas" runat="server" AutoGenerateColumns="false" Width="100%"  Height="400px" 
                     OnItemCommand="grdZonas_ItemCommand"
                      >
                        <MasterTableView>
                            <Columns>

                                <telerik:GridBoundColumn DataField="ID_Zona" HeaderText="ID_Zona" UniqueName="ID_Zona" Visible="false">
