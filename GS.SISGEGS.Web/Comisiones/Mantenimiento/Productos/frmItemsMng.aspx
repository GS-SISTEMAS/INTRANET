<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPopUpS.Master" AutoEventWireup="true" CodeBehind="frmItemsMng.aspx.cs" Inherits="GS.SISGEGS.Web.Comision.Mantenimiento.Productos.frmItemsMng" %>
    ...
    <telerik:RadAjaxPanel ID="rapEmpresaMng" runat="server" Width="100%">
        ...
        <div class="fila">
         ...
         <div class="fila">
            ...
            <div class="colum3">
                <telerik:RadTextBox ID="txtComision" runat="server" Width="80%"  ></telerik:RadTextBox>
                 <asp:Label ID="Label9" runat="server" Text="%" CssClass="etiqueta"></asp:Label>
            </div>
