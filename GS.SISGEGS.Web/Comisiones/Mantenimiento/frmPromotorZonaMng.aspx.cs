...
{
    public partial class frmPromotorZonaMng : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    Empresa_Cargar();
                    Cargo_Cargar(((Usuario_LoginResult)Session["Usuario"]).idEmpresa.ToString());
                    Reporte_Cargar(((Usuario_LoginResult)Session["Usuario"]).idEmpresa.ToString());
                    Zona_Cargar();
                    ...
                    if (Request.QueryString["objPromotor"] == "")
                    {
                        ...
                        string obj = Request.QueryString["objPromotor"];
                        Personal_ListarTotalResult objPersonal = JsonHelper.JsonDeserialize<Personal_ListarTotalResult>(Request.QueryString["objPromotor"]);
                        ...
                        txtComision.Text = decimal.Round(numero,2).ToString();
                        txtImagen.Text = objPersonal.ImagenURL; 

                        cboCargo.SelectedValue = objPersonal.codCargo.ToString();
                        ...
                        cboZonas.SelectedValue = objPersonal.id_zona.ToString(); 
                    ...
                    Session["idReporte"] = cboReporte.SelectedValue;
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                objComison.gsAgenda_UpdateZona(idEmpresa, ((Usuario_LoginResult)Session["Usuario"]).codigoUsuario, nroDocumento, int.Parse(cboZonas.SelectedValue)); 
        ...
        public static AutoCompleteBoxData Item_BuscarUsuario(object context)
        {
            ...
            if (!string.IsNullOrEmpty(searchString) && searchString.Length >= 4)
            {
                ...
                List<Personal_BuscarResult> lst = objUsuarioWCF.Personal_Buscar(int.Parse(idempresa),
                    ((Usuario_LoginResult)HttpContext.Current.Session["Usuario"]).codigoUsuario, idempresa, null, searchString).ToList();
        ...
        protected void btnBuscarUsuario_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                txtImagen.Text = objUsuario.ImagenURL;

                numero = Convert.ToDecimal(objUsuario.porcentaje);
                numero = numero * 100;

                cboCargo.SelectedValue = objUsuario.codCargo.ToString();
                cboZonas.SelectedValue = objUsuario.id_zona.ToString(); 

                //cboReporte.SelectedValue = objUsuario.reporte.ToString();
