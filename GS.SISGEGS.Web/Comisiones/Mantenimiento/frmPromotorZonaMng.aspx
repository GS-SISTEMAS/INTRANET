<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPopUpS.Master" AutoEventWireup="true" CodeBehind="frmPromotorZonaMng.aspx.cs" Inherits="GS.SISGEGS.Web.Comision.Mantenimiento.frmPromotorZonaMng" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <telerik:RadAjaxPanel ID="rapEmpresaMng" runat="server" Width="100%">
           ...
           <div class="fila" id="dUsuario">
               ...
               <div class="colum6">
                    <telerik:RadAutoCompleteBox ID="acbUsuario" runat="server" Width="100%" TextSettings-SelectionMode="Single" InputType="Text" 
                         ...
                         <WebServiceSettings Method="Item_BuscarUsuario" Path="frmPromotorZonaMng.aspx" />
               ...
               <div class="colum7">
                           <telerik:RadComboBox ID="cboCargo" runat="server" DataTextField="VchDescripcionCargo" DataValueField="chrCodigoCargo" ></telerik:RadComboBox>
               </div>
         </div>

          <div class="fila">
               <div class="colum2">
                       <asp:Label ID="Label7" runat="server" Text="Zonas" CssClass="etiqueta"></asp:Label>
               </div>
               <div class="colum7">
                        <telerik:RadComboBox ID="cboZonas"  runat="server" 
                           
                             DataValueField="id_zona"  DataTextField="zona"                  
                             ></telerik:RadComboBox>
               </div>
       ...
       <div class="fila" >
            <div class="colum2">
                <asp:Label ID="Label9" runat="server" Text="Imagen" CssClass="etiqueta" Visible="false"></asp:Label>
            </div>
            <div class="colum7">
...
<asp:Content ID="Content3" ContentPlaceHolderID="mensaje" runat="server">
    <div class="fila">
        <div class="colum10">
            ...
            <asp:Label ID="lblComision" Visible="false" runat="server"></asp:Label>
        </div>
    </div>
</asp:Content>
