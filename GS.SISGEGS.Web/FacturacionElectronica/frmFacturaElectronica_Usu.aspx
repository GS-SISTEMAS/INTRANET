<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmFacturaElectronica_Usu.aspx.cs" Inherits="GS.SISGEGS.Web.FacturacionElectronica.frmFacturaElectronica_Usu" %>
            ...
            <div class="col-md-12">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                             <telerik:RadButton ID="btnRegistrar" runat="server" OnClick="btnRegistrar_Click" style="top: 1px; left: 3px" Text="Enviar Sunat" Width="120px">
                       ...
                       <td colspan="2"> 
                             <telerik:RadButton ID="btnToggle" runat="server" ToggleType="CheckBox" ButtonType="ToggleButton" Width="110px">
                                <ToggleStates>
                                    <telerik:RadButtonToggleState Text="Anticipos(Solo)" PrimaryIconCssClass="rbToggleCheckboxChecked" />
                                    <telerik:RadButtonToggleState Text="Anticipos(Solo)" PrimaryIconCssClass="rbToggleCheckbox" />
                                </ToggleStates>
                            </telerik:RadButton>
                        </td>

                        <td>
                               <telerik:RadButton ID="RadButton1" runat="server" Visible="false" OnClick="btnRegistrarPrueba_Click" style="top: 1px; left: 3px" Text="Enviar Sunat" Width="130px">
                                <Icon PrimaryIconUrl="../Images/Icons/box-out-16.png" />
                            </telerik:RadButton>
                        </td>
                        ...
                        <Columns>
                           ...
                           <telerik:GridMaskedColumn DataField="OpOrigen" HeaderText="#Op" FilterControlWidth="45px" AutoPostBackOnFilter="false" AllowSorting="true"
                            ...
                            <telerik:GridBoundColumn FilterControlWidth="150px" DataField="RespuestaTCI" HeaderText="RespuestaTCI" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false">
                             ...
                             <telerik:GridBoundColumn DataField="Codigo" Visible="false" HeaderText="Cod.Cliente" HeaderStyle-Width="80px" AllowSorting="false"  AllowFiltering="false">
