<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmFacturaElectronica_RetUsu.aspx.cs" Inherits="GS.SISGEGS.Web.FacturacionElectronica.frmFacturaElectronica_RetUsu" %>
            ...
            <div class="col-md-12">
                ...
                <table>
                  ...
                  <tr>
                        ...
                        <td class="auto-style1" colspan="2">
                          <telerik:RadComboBox ID="cboTipoDoc" runat="server" Width="400px">
                          </telerik:RadComboBox>
                        </td>
                        <td class="auto-style1">
                             &nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>
                             <telerik:RadButton ID="btnRegistrar" runat="server" OnClick="btnRegistrar_Click" style="top: 1px; left: 3px" Text="Enviar SUNAT" Width="130px">
                ...
                <telerik:RadGrid ID="grdFacturaElectronica" runat="server" AllowMultiRowSelection="false" AutoGenerateColumns="False" Height="520px"  Width="100%"
                    ...
                    <MasterTableView DataKeyNames="OpOrigen,TablaOrigen,Serie,Numero" ClientDataKeyNames="OpOrigen,TablaOrigen,Serie,Numero"  AutoGenerateColumns="false" AllowFilteringByColumn="true" ShowFooter="True" >
                        <Columns>
                           ...
                           <telerik:GridMaskedColumn DataField="Op" HeaderText="#Op" FilterControlWidth="45px" AutoPostBackOnFilter="false" AllowSorting="true"
                            ...
                            <telerik:GridBoundColumn DataField="TablaOrigen" HeaderText="TablaOrigen" HeaderStyle-Width="90px" AllowSorting="false" AllowFiltering="false" Display="false">
                            ...
                            <telerik:GridBoundColumn FilterControlWidth="80px" DataField="SerieNumero" HeaderText="Transaccion" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false">
                                        <HeaderStyle Width="90px" />
                            </telerik:GridBoundColumn>

                             <telerik:GridTemplateColumn UniqueName="CheckColumnOto" HeaderText="Otorgar" HeaderStyle-Width="40px" AllowSorting="true" AllowFiltering="false">
                              <ItemTemplate>
                                <asp:CheckBox ID="CheckOto" runat="server" />
                              </ItemTemplate>
                             </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridBoundColumn FilterControlWidth="250px" DataField="Nombre" HeaderText="Proveedor" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false">
