<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmGeneralMarcas.aspx.cs" Inherits="GS.SISGEGS.Web.Contratos.Reportes.frmGeneralMarcas" %>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    ...
                    &nbsp;&nbsp;
                    <asp:Label runat="server" ID="Label1" Text="Todo" CssClass="etiqueta"></asp:Label>&nbsp;<asp:CheckBox runat="server" ID="checkTodasFechas"/>
                </div>
                <div class="col-md-2">
