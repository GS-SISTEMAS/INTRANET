<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmOrdenVentaGestion.aspx.cs" Inherits="GS.SISGEGS.Web.Finanzas.Aprobacion.frmOrdenVentaGestion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <telerik:RadAjaxManager ID="ramOrdenVenta" runat="server" >
        <AjaxSettings>
                ...
                <telerik:LayoutRow>
                    <Columns>
                        <telerik:LayoutColumn Span="12">
                             <asp:Label ID="lblTitulo" runat="server" Text="Gestión de Pedidos Comercial: " CssClass="titulo"></asp:Label>
                            ...
                            <telerik:RadPane ID="RadPane1" runat="server" Width="22px" Scrolling="None">
                                <telerik:RadSlidingZone ID="RadSlidingZone1" runat="server" Width="22px">
                                    <telerik:RadSlidingPane ID="RadSlidingPane1" runat="server" Width="400px" Title="Filtros de Busqueda"
                                       ...
                                       <div class="fila">
                                           <div class="colum3">
                                                <asp:Label ID="Label2" runat="server" Text="Estado Pedido:" CssClass="etiqueta"></asp:Label>
                                            </div>
                                            <div class="colum7">
                                          ...
                                          <div class="fila">
                                           <div class="colum3">
                                                <asp:Label ID="Label5" runat="server" Text="Flujo: " CssClass="etiqueta"></asp:Label>
                                            </div>
                                            <div class="colum7">
                                                <telerik:RadComboBox ID="cboFlujo" runat="server"  Width="250px"  >
                                                </telerik:RadComboBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="fila">
                                           <div class="colum3">
                                                <asp:Label ID="Label4" runat="server" Text="Tipo Bloqueo:" CssClass="etiqueta"></asp:Label>
                                            </div>
                                            <div class="colum7">
                                                <telerik:RadComboBox ID="cboBloqueo" runat="server"  Width="250px"  >
                                                </telerik:RadComboBox>
                                            </div>
