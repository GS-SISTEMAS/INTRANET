<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmOrdenVentaMkt.aspx.cs" Inherits="GS.SISGEGS.Web.Finanzas.Aprobacion.frmOrdenVentaMkt" %>
                ...
                <telerik:LayoutRow>
                    <Columns>
                        <telerik:LayoutColumn Span="12">
                             <asp:Label ID="lblTitulo" runat="server" Text="Gestión de Pedidos Gratuitos: " CssClass="titulo"></asp:Label>
                            ...
                            <telerik:RadPane ID="RadPane1" runat="server" Width="22px" Scrolling="None">
                                <telerik:RadSlidingZone ID="RadSlidingZone1" runat="server" Width="22px">
                                    <telerik:RadSlidingPane ID="RadSlidingPane1" runat="server" Width="400px" Title="Filtros de Busqueda"
                                        ...
                                        <div class="fila">
                                           <div class="colum3">
                                                <asp:Label ID="Label1" runat="server" Text="Tipo Pago:" CssClass="etiqueta"></asp:Label>
                                            </div>
                                            <div class="colum7">
                                                <telerik:RadComboBox ID="cboFormaPago" runat="server"  Width="250px"  >
                                                </telerik:RadComboBox>
                                            </div>
                                        ...
                                        <Content>
                                                ...
                                                <MasterTableView ShowFooter="True" DataKeyNames="Op" ClientDataKeyNames="Op" Width="2060px">
                                                    ...
                                                    <Columns>
                                                       ...
                                                       <telerik:GridTemplateColumn UniqueName="CheckColumn" HeaderText="Aprobar" HeaderStyle-Width="40px" AllowSorting="true" AllowFiltering="false">
                                                          <ItemTemplate>
