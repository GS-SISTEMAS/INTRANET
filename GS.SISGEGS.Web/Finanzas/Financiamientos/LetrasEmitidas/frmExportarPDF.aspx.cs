...
namespace GS.SISGEGS.Web.Finanzas.Financiamientos.LetrasEmitidas
{
    public partial class frmExportarPDF : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string idOperacion;
            idOperacion = Convert.ToString(Request.QueryString["idOperacion"]);

            LetrasEmitidas_Cabecera(idOperacion);
            LetrasEmitidas_Documentos(idOperacion);
            LetrasEmitidas_Letras(idOperacion);

            ExpPDFDetalle(idOperacion);
