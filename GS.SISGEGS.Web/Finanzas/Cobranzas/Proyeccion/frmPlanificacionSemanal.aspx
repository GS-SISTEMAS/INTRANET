<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPopUpSM.Master" AutoEventWireup="true" CodeBehind="frmPlanificacionSemanal.aspx.cs" Inherits="GS.SISGEGS.Web.Finanzas.Cobranzas.Proyeccion.frmPlanificacionSemanal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <telerik:RadAjaxLoadingPanel ID="ralpUsuarioMngEdit" runat="server"   ></telerik:RadAjaxLoadingPanel>
     ...
     <telerik:RadAjaxPanel ID="rapUsuarioMngEdit" runat="server" whith="100%"  >
