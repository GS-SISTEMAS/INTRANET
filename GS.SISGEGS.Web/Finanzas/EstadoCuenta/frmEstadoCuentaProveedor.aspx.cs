...
{
    public partial class frmEstadoCuentaProveedor : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    dpFecInicio.SelectedDate = DateTime.Now.AddMonths(-year + 1 );
        ...
        protected void grdDocumentos_NeedDataSource(object sender, PivotGridNeedDataSourceEventArgs e)
        {
            ...
            try
            {
                grdDocumentos.DataSource = JsonHelper.JsonDeserialize<List<VBG00062_PROVEEDORResult>>((string)ViewState["lstDocumentos"]);
            }
            catch (Exception ex)
            {
                rwmReporte.RadAlert(ex.Message, 500, 100, "Error al descargar el excel", "");
