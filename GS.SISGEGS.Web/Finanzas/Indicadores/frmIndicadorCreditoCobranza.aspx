<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmIndicadorCreditoCobranza.aspx.cs" Inherits="GS.SISGEGS.Web.Finanzas.Indicadores.frmIndicadorCreditoCobranza" %>
                        ...
                        <td>
                                    ...
                                    <telerik:RadPivotGrid ID="grdIndicadores" runat="server" Width="100%" Height="100%" AllowFiltering="false" 
                                        ...
                                        <Fields>
                                           ...
                                           <telerik:PivotGridAggregateField DataField="Vencido30a180" Aggregate="Sum" DataFormatString="${0:##,###0.##}">
                                                <HeaderCellTemplate>
                                                    Vencido30a180   
                                                </HeaderCellTemplate>
                                            </telerik:PivotGridAggregateField>
                                           <telerik:PivotGridAggregateField  DataField="sumaDeuda" Aggregate="Sum" DataFormatString="${0:##,###0.##}">
                                                <HeaderCellTemplate>
                                                    Total Deuda
                                                </HeaderCellTemplate>
                                           </telerik:PivotGridAggregateField>

                                            <telerik:PivotGridAggregateField DataField="indDeudaVencida" CalculationDataFields="Vencido30a180,sumaDeuda" CalculationExpression="({0}/{1})*100" DataFormatString="{0:##,###0.##} %">
                                                <HeaderCellTemplate>
                                                    IndDeudaVencida
                                                </HeaderCellTemplate>
