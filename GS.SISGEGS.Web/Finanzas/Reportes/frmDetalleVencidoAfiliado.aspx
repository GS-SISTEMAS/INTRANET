<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPopUpSX.Master" AutoEventWireup="true" CodeBehind="frmDetalleVencidoAfiliado.aspx.cs" Inherits="GS.SISGEGS.Web.Finanzas.Reportes.frmDetalleVencidoAfiliado" %>
    ...
    <telerik:RadAjaxPanel ID="rapUsuarioMngEdit" runat="server" Width="100%">
           ...
           <div class="fila">
               ...
               <div class="colum7">
                    ...
                    AutoGenerateColumns="False" Height="220px"  Width="300px"  ShowFooter="true" 
                    AllowSorting="True" OnItemDataBound="grdVencidos_ItemDataBound1" >
                    <MasterTableView TableLayout="Fixed"
                        AllowMultiColumnSorting="true"    >
                        <Columns>

                            <telerik:GridBoundColumn DataField="id_agenda" HeaderText="Codigo" HeaderStyle-Width="100px" AllowSorting="false" Visible="false"  >
                            </telerik:GridBoundColumn>

                               <telerik:GridBoundColumn DataField="clientenombre" HeaderText="Cliente" HeaderStyle-Width="150px" AllowSorting="false"  >
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="DeudaMes" HeaderText="Importe Vencido" HeaderStyle-Width="80px" 
