<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmVentasCobranzasDetalle.aspx.cs" Inherits="GS.SISGEGS.Web.Finanzas.Reportes.frmVentasCobranzasDetalle" %>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <table>
                    ...
                    <tr>
                        <td class="auto-style1">
                             <asp:Label ID="Label1" runat="server" CssClass="etiqueta" Text="Cliente: " Width="116px"></asp:Label>
                        </td>
                        ...
                        <td colspan="3">
                              <telerik:RadAutoCompleteBox ID="acbCliente" runat="server" AllowCustomEntry="true" DropDownHeight="150px" 
                                ...
                                OnClientEntryAdding="OnClientEntryAddingHandler" TextSettings-SelectionMode="Single" Width="400px" Visible="true"> 
                    ...
                    <tr>
                        <td class="auto-style1">
                             <asp:Label ID="Label2" runat="server" CssClass="etiqueta" Text="Vendedor: " Width="116px"></asp:Label>
                        </td>
                        ...
                        <td colspan="3">
                             <telerik:RadAutoCompleteBox ID="acbVendedor" runat="server" AllowCustomEntry="true" DropDownHeight="150px" DropDownWidth="300px" EmptyMessage="Selec. vendedor / Todos" 
                                InputType="Text" OnClientEntryAdding="OnClientEntryAddingHandler" TextSettings-SelectionMode="Single" Width="400px" Visible="true">
               ...
               <table>
                ...
                <telerik:RadGrid ID="grdVentasCobranzas" runat="server" AllowMultiRowSelection="false"
                    AutoGenerateColumns="False" Height="220px"  Width="90%"
                    ...
                    <MasterTableView TableLayout="Fixed" DataKeyNames="id_cliente"
                        ...
                        <Columns>
                            <telerik:GridBoundColumn DataField="conceptos" HeaderText="" HeaderStyle-Width="110px" AllowSorting="false"  >
