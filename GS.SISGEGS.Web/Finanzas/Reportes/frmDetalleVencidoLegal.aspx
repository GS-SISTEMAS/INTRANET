<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPopUpSX.Master" AutoEventWireup="true" CodeBehind="frmDetalleVencidoLegal.aspx.cs" Inherits="GS.SISGEGS.Web.Finanzas.Reportes.frmDetalleVencidoLegal" %>
    ...
    <telerik:RadAjaxPanel ID="rapUsuarioMngEdit" runat="server" Width="100%">
           ...
           <div class="fila">
               ...
               <div class="colum7">
                    ...
                    AutoGenerateColumns="False" Height="220px"  Width="270px"
