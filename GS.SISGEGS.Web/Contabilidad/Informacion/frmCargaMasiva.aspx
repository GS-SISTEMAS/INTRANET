<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPopUpCargaMasiva.Master" AutoEventWireup="true" CodeBehind="frmCargaMasiva.aspx.cs" Inherits="GS.SISGEGS.Web.Contabilidad.Informacion.frmCargaMasiva" %>
      ...
      <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server" Height="120px" CssClass="background1">
                   <div class="fila containerSubTitulo">
                        <div class="colum10">
                            <asp:Label ID="Label11" runat="server" Text="Carga masiva de números únicos:" CssClass="subTitulo"></asp:Label>
                        </div>
                  </div>
                   <div class="fila">
                    <div class="colum6">
