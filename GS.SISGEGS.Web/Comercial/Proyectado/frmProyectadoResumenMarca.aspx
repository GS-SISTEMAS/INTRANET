<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmProyectadoResumenMarca.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Proyectado.frmProyectadoResumenMarca" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Grupo Silvestre: Reporte pronóstico por marca
</asp:Content>
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btnBuscar">
             ...
             <telerik:AjaxSetting AjaxControlID="grdPronostico">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdPronostico" LoadingPanelID="ralpReporte"></telerik:AjaxUpdatedControl>
                </UpdatedControls>
            </telerik:AjaxSetting>
        ...
        <telerik:RadPageLayout ID="RadPageLayout1" runat="server" Height="100%" Width="100%">
            <Rows>
                <telerik:LayoutRow>
                    <Content>
                        <div class="col-md-11">
                            <asp:Label ID="lblTitulo" runat="server" CssClass="titulo" Text="Reporte de pronóstico por marca"></asp:Label>
                        </div> 
                        <div class="col-md-1">
                        ...
                        <telerik:LayoutColumn Span="12" Height="100%">
                            <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Height="100%"
                                ...
                                <telerik:RadPane ID="RadPane2" runat="server" Width="100%" Scrolling="Both" Height="100%">
                                    ...
                                    <telerik:RadPivotGrid ID="grdPronostico" runat="server" Width="99%" Height="600px" AllowFiltering="false" 
                                        OnCellDataBound="grdPronostico_CellDataBound"
                                        ShowFilterHeaderZone="false" OnPivotGridCellExporting="grdPronostico_PivotGridCellExporting"
                                        ShowDataHeaderZone="false" ShowRowHeaderZone="false" ShowColumnHeaderZone="false" EnableConfigurationPanel="true" 
                                        TotalsSettings-GrandTotalsVisibility="RowsOnly"  OnNeedDataSource="grdPronostico_NeedDataSource"
                                        AllowSorting="true"
                                        ...
                                        <Fields>
                                            ...
                                            <telerik:PivotGridRowField DataField="SKU_Nombre" ZoneIndex="1">
                                           ...
                                           <telerik:PivotGridAggregateField  DataField="Cantidad"  DataFormatString="{0:##,###0.##}"  CellStyle-Width="80px">
                                                <HeaderCellTemplate >
                                                    Cantidad Pronos.
                                                </HeaderCellTemplate>
                                           </telerik:PivotGridAggregateField>

                                            <telerik:PivotGridAggregateField  DataField="CantidadKL"  DataFormatString="{0:##,###0.##}"  CellStyle-Width="80px">
                                                <HeaderCellTemplate >
                                                    Cantidad K/L Pronos.
                                                </HeaderCellTemplate>
                                           </telerik:PivotGridAggregateField>

                                            <telerik:PivotGridAggregateField  DataField="VentaPronostico" Aggregate="Sum" DataFormatString="${0:##,###0.##}"  CellStyle-Width="80px">
                                                <HeaderCellTemplate >
                                                    Valor Pronos.
                                                </HeaderCellTemplate>
                                           </telerik:PivotGridAggregateField>
