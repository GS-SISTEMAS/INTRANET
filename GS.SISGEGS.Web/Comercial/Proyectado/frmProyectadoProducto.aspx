<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmProyectadoProducto.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Proyectado.frmProyectadoProducto" %>
    ...
    <telerik:RadAjaxPanel ID="pnlProyectado" runat="server" Width="100%" Height="700px" ClientEvents-OnRequestStart="requestStart" >
        ...
        <div class="row"> 
             <div class="col-md-12">
                ...
                <div class="col-md-1">
                    <asp:Label ID="Label3" runat="server" Text="Año:" CssClass="etiqueta"></asp:Label>
                </div>

                <div class="col-md-1">
                         <telerik:RadComboBox ID="cboAnho" runat="server" AutoPostBack="true" Width="100%" DropDownWidth="150px"  
                           OnSelectedIndexChanged="cboAnho_SelectedIndexChanged" Enabled="true" >
                     </telerik:RadComboBox>
                </div>
              ...
              <div class="col-md-1">
                ...
                <div class="col-md-1">
                    <telerik:RadMonthYearPicker ID="rmyReporte0" runat="server" Width="110px" DateInput-ReadOnly="true"  Enabled="false" >
                        <DateInput ID="DateInput1" runat="server" DateFormat="MM-yyyy"></DateInput>
                    </telerik:RadMonthYearPicker>
                </div>
                 <div class="col-md-1">
                    <telerik:RadMonthYearPicker ID="rmyReporte" runat="server" Width="110px" DateInput-ReadOnly="true" Enabled="false" >
             ...
             <div class="col-md-12">
                <div class="col-md-1">
                 ...
                 <div class="col-md-3">
                      <telerik:RadComboBox ID="cboZona" runat="server" AutoPostBack="true" Width="100%" DropDownWidth="400px"  
                           OnSelectedIndexChanged="cboZona_SelectedIndexChanged" Enabled="true" >
                     </telerik:RadComboBox>
                 </div>
                                ...
                                <telerik:RadGrid  Height="500px"
                                    ...
                                    <MasterTableView
                                        ...
                                        <Columns>
                                           ...
                                           <telerik:GridBoundColumn HeaderText="Q.Venta" DataField="CantidadReal1" DataFormatString="{0:#,##0.00}" Aggregate="Sum" HeaderStyle-ForeColor="Blue">
                                                <HeaderStyle Width="100px" Font-Bold="true"  BackColor="Cyan"/>
                                                <FooterStyle Font-Bold="true" HorizontalAlign="Right"/>
                                                <ItemStyle HorizontalAlign="Right"  />
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn HeaderText="Q.Venta" DataField="CantidadReal2" DataFormatString="{0:#,##0.00}" Aggregate="Sum" HeaderStyle-ForeColor="Red">
                                                <HeaderStyle Width="100px" Font-Bold="true" BackColor="GreenYellow" />
                                                 <FooterStyle Font-Bold="true" HorizontalAlign="Right"/>
                                                 <ItemStyle HorizontalAlign="Right" />
                                            </telerik:GridBoundColumn>

                                           <telerik:GridBoundColumn HeaderText="Q.PPTO" DataField="CantidadPronostico2" DataFormatString="{0:#,##0.00}" Aggregate="Sum" HeaderStyle-ForeColor="Red">
                                                <HeaderStyle Width="100px" Font-Bold="true" BackColor="GreenYellow"/>
                                                <FooterStyle Font-Bold="true" HorizontalAlign="Right"/>
                                                  <ItemStyle HorizontalAlign="Right"  />
                                            </telerik:GridBoundColumn>
