<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmPronosticoVsReal.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Proyectado.frmPronosticoVsReal" %>
...
<telerik:RadAjaxPanel ID="pnlGeneralContratos" runat="server" Width="100%" Height="100%"  ClientEvents-OnRequestStart="requestStart">
        <div class="row">
            <div class="col-md-11">
                <asp:Label ID="lblTitulo" runat="server" Text="Seguimiento del pronóstico vs venta real" CssClass="titulo"></asp:Label>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <telerik:RadPivotGrid ID="grdComparativoPivot" runat="server" Width="99%" Height="470px" AllowFiltering="false" 
                            ...
                            <Fields >
                                ...
                                <telerik:PivotGridAggregateField  DataField="CantidadReal" DataFormatString="{0:##,###0.##}"  CellStyle-Width="80px">
                                    <HeaderCellTemplate >
                                        Cantidad Vendida Real K/L
                                    </HeaderCellTemplate> 
                                </telerik:PivotGridAggregateField>

                                <telerik:PivotGridAggregateField  DataField="CantidadPronosticada"  DataFormatString="{0:##,###0.##}"  CellStyle-Width="80px">
                                    <HeaderCellTemplate >
                                        Cantidad Pronosticada K/L
                                    </HeaderCellTemplate>
                                </telerik:PivotGridAggregateField>

                                <telerik:PivotGridAggregateField  DataField="CantidadPresupuestada"  DataFormatString="{0:##,###0.##}"  CellStyle-Width="80px">
                                    <HeaderCellTemplate >
                                        Cantidad Presupuestada K/L
                                    </HeaderCellTemplate>
                                </telerik:PivotGridAggregateField>

                                <telerik:PivotGridAggregateField  DataField="CantidadAnterior"  DataFormatString="{0:##,###0.##}"  CellStyle-Width="80px">
                                    <HeaderCellTemplate >
                                        Cantidad Año Anterior K/L
                                    </HeaderCellTemplate>
                                </telerik:PivotGridAggregateField>

                                <telerik:PivotGridAggregateField  DataField="CumplimientoPronostico"  DataFormatString="{0:##,###0.##}%"  CellStyle-Width="80px"
                                     CalculationDataFields="CantidadReal,CantidadPronosticada" CalculationExpression="({0}/{1})*100">
                                    <HeaderCellTemplate >
                                ...
                                <telerik:PivotGridAggregateField  DataField="CumplimientoPresupuesto"  DataFormatString="{0:##,###0.##}%"  CellStyle-Width="80px"
                                     CalculationDataFields="CantidadReal,CantidadPresupuestada" CalculationExpression="({0}/{1})*100">
                                    <HeaderCellTemplate >
                                ...
                                <telerik:PivotGridAggregateField  DataField="CumplimientoAnterior" DataFormatString="{0:##,###0.##}%"  CellStyle-Width="80px"
                                     CalculationDataFields="CantidadReal,CantidadAnterior" CalculationExpression="({0}/{1})*100">
                                    <HeaderCellTemplate>
