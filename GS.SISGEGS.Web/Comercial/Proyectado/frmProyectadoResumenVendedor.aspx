<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmProyectadoResumenVendedor.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Proyectado.frmProyectadoResumenVendedor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Grupo Silvestre: Reporte pronóstico por vendedor
</asp:Content>
        ...
        <telerik:RadPageLayout ID="RadPageLayout1" runat="server" Height="100%" Width="100%">
            <Rows>
                <telerik:LayoutRow>
                    <Content>
                        <div class="col-md-11">
                            <asp:Label ID="lblTitulo" runat="server" CssClass="titulo" Text="Reporte de pronóstico por zona"></asp:Label>
                        </div> 
                        <div class="col-md-1">
