<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmRendGastos.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Gastos.frmRendGastos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        //    window.radopen("frmRendGastosMng.aspx?idOperacion=" + id, "rwEgresosVarios");
        //    return false;
        //}
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <telerik:RadAjaxPanel ID="rapEgresosVarios" runat="server" Width="100%" Height="100%" ClientEvents-OnRequestStart="requestStart">
        <div class="row">
            ...
            <div class="col-md-6">
                <asp:Label ID="lblTitulo" runat="server" Text="Rendición de Gastos de los colaboradores" CssClass="titulo"></asp:Label>
            </div>
                        ...
                        <telerik:RadSlidingZone ID="RadSlidingZone1" runat="server" Width="22px">
                            <telerik:RadSlidingPane ID="RadSlidingPane1" runat="server" Width="300px" Title="Filtros de Busqueda"
                                ...
                                <div class="fila">
                                 ...
                                 <div class="fila">
                                    <div class="colum4">
                                           <asp:Label ID="Label1" runat="server" CssClass="etiqueta" Text="Ver Planillas:"></asp:Label>
                                    </div>
                                     <div class="colum3">
                                            <asp:CheckBox runat="server" ID="chkVerPlanillas"/>
                                     </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <telerik:RadGrid ID="grdEgresosVarios" runat="server" AutoGenerateColumns="false" Width="100%" Height="500px" AllowSorting="True" ShowFooter="True" 
                                    ...
                                    <MasterTableView Width="1630px" DataKeyNames="Id" ClientDataKeyNames="Id" AllowFilteringByColumn="True">
                                        <Columns>
                                            ...
                                            <telerik:GridMaskedColumn DataField="Id" HeaderText="Nro." FilterControlWidth="45px" AutoPostBackOnFilter="true"
                                                CurrentFilterFunction="EqualTo" FilterDelay="2000" ShowFilterIcon="false" Mask="########" UniqueName="Id">
                                                <HeaderStyle Width="50px" />
                                                <ItemStyle Height="42px" />
                                            </telerik:GridMaskedColumn>
                                             <telerik:GridBoundColumn DataField="Op" HeaderText="Op Genesys" UniqueName="Op">
                                            ...
                                            <telerik:GridBoundColumn DataField="Moneda" HeaderText="Moneda" UniqueName="Moneda">
                                             ...
                                             <telerik:GridBoundColumn DataField="EstadoFlujo" HeaderText="Estado Flujo" UniqueName="EstadoFlujo" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false">
