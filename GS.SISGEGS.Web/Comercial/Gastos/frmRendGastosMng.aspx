<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmRendGastosMng.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Gastos.frmRendGastosMng" %>
    ...
    <telerik:RadAjaxPanel ID="rapGastosMng" runat="server" Width="100%" ClientEvents-OnRequestStart="requestStart">
        ...
        <div class="fila">
            <div class="colum3">
                <telerik:LayoutColumn Span="11">
                        <asp:Label ID="lblTitulo" runat="server" CssClass="titulo" Text="Registrar Rendición de Gastos"></asp:Label>
                    </telerik:LayoutColumn>
            </div>
            <div class="colum2" style="text-align: right">
                ...
                <telerik:RadButton ID="btnAprobar" runat="server" Text="Enviar Planilla a Recepción" OnClick="btnAprobar_Click">
         ...
         <div class="fila">
            <div class="colum10">
                <asp:Label ID="lblError" runat="server" style="font-size:16px"></asp:Label>
            </div>
        </div>
        <div class="fila">
             &nbsp;
        ...
        <div class="fila">
            <div class="colum3">
                ...
                <div class="colum7">
                    <telerik:RadTextBox ID="txtConcepto" runat="server" TextMode="MultiLine" Width="100%" Height="60px"></telerik:RadTextBox>
                </div>
            </div>
        ...
        <div class="fila" style="padding-top:20px">
            <div class="colum10">
                <telerik:RadGrid ID="grdRecibos" runat="server" AutoGenerateColumns="false" Height="300px" Width="100%" 
        ...
        <div class="fila">
            ...
            <div class="colum7">
                <telerik:RadTextBox ID="txtObservacion" runat="server" TextMode="MultiLine" Width="100%" Height="60px"></telerik:RadTextBox>
            </div>
        </div>

        <div class="fila">
            <div class="colum3">
                <asp:Label ID="lblFlujo" runat="server" text="Flujo Aprobación" CssClass="titulo"></asp:Label>
            </div>
        </div>
        <div class="fila">
            <div class="colum10">
                <telerik:RadGrid ID="grdFlujo" runat="server" AutoGenerateColumns="false" Height="130px" Width="60%">
                    <MasterTableView  Width="450px"  >
                        <Columns>
                            
                            <telerik:GridBoundColumn DataField="Orden" HeaderText="Orden" UniqueName="Orden">
                                <HeaderStyle Width="40px" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Descripcion" HeaderText="Flujo" UniqueName="Descripcion">
                                <HeaderStyle Width="200px" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Aprobado" HeaderText="Estado" UniqueName="Aprobado">
                                <HeaderStyle Width="80px" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Observacion" HeaderText="Observacion" UniqueName="Observacion">
                                <HeaderStyle Width="300px" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="fechaAprobacion" HeaderText="Fecha de Aprobación" UniqueName="fechaAprobacion">
                                <HeaderStyle Width="300px" />
                            </telerik:GridBoundColumn>
                        </Columns>
                    </MasterTableView>
