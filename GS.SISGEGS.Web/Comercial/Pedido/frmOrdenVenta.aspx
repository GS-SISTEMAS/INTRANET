<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmOrdenVenta.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Pedido.frmOrdenVenta" %>
                                ...
                                <telerik:RadPageLayout ID="RadPageLayout2" runat="server" Height="100%">
                                    <telerik:LayoutRow Height="100%">
                                        <Content>
                                                ...
                                                OnNeedDataSource="grdOrdenVenta_NeedDataSource" 
                                                OnDeleteCommand="grdOrdenVenta_DeleteCommand"
                                                OnItemCommand="grdOrdenVenta_ItemCommand" 
                                                OnItemDataBound="grdOrdenVenta_ItemDataBound">
                                                ...
                                                <MasterTableView ShowFooter="True" DataKeyNames="Op" ClientDataKeyNames="Op" Width="2060px">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <telerik:GridBoundColumn UniqueName="FechaOrden" DataField="FechaOrden" HeaderText="Fecha" AllowFiltering="false"
                                                            ...
                                                            <telerik:GridCheckBoxColumn HeaderText="Bloq." UniqueName="Bloqueado" DataField="Bloqueado" ItemStyle-HorizontalAlign="Right" ShowFilterIcon="false" AllowFiltering="false">
                                                            <HeaderStyle Width="40px" />
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="DesAprobar" AllowFiltering="false" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:Button ID="btnAprobar" runat="server" CommandArgument='<%# Eval("Op") %>' CommandName="Desaprobar" />
                                                            </ItemTemplate>
                                                            <HeaderStyle Width="90px" />
                                                        </telerik:GridTemplateColumn>

                                                        <telerik:GridButtonColumn ConfirmText="¿Desea eliminar el pedido?" ConfirmDialogType="RadWindow"
                                                            HeaderStyle-Width="80px" HeaderText="Eliminar" ConfirmTitle="Eliminar" ButtonType="ImageButton"
                                                            CommandName="Delete" ImageUrl="../../Images/Icons/delete-16.png" UniqueName="Eliminar" />
