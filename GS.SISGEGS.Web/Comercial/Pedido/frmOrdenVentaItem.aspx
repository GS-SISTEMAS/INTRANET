<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPopUpS.Master" AutoEventWireup="true" CodeBehind="frmOrdenVentaItem.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Pedido.frmOrdenVentaItem" %>
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function CalcularImporte() {
            ...
            var txtDescuentoMax = $find("<%= txtDescuentoMax.ClientID %>");
            var txtDescuentoFinal = $find("<%= txtDescuentoFinal.ClientID %>");
            ...
            var descuentoMax = txtDescuentoMax.get_textBoxValue();
            var descuentoFinal = txtDescuentoFinal.get_textBoxValue();
            ...
            if (parseFloat(descuentoMax) < parseFloat(descuentoFinal) || parseFloat(descuentoFinal) < 0) {
                txtDescuentoFinal.set_value(parseFloat(descuentoInicial));
        ...
        function Afecto() {
            alert('El producto es Afecto al IGV, por favor, registrarlo en otro pedido.');
           
        }

        function Inafecto() {
            alert('El producto es Inafecto al IGV, por favor, registrarlo en otro pedido.');
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <telerik:RadAjaxPanel ID="pnlPedidoItem" runat="server">
        ...
        <div class="fila">
            ...
            <div class="colum2">
                <asp:Label ID="lblDescuento" runat="server" Text="Desc.Max." CssClass="etiqueta"></asp:Label>
            </div>
            <div class="colum2">
                <telerik:RadNumericTextBox ID="txtDescuentoMax" runat="server"  Width="100%" Enabled="false" >
                </telerik:RadNumericTextBox>
            </div>
            <div class="colum1">
        ...
        <div class="fila">
            ...
            <div class="colum2">
             ...
             <div class="colum1">
                <asp:Label ID="Label3" runat="server" CssClass="etiqueta" Text="% " ></asp:Label>
            </div>  
              <div class="colum2">
                <asp:Label ID="Label1" runat="server" Text="Descuento" CssClass="etiqueta"></asp:Label>
            </div>
            <div class="colum2">
                <telerik:RadNumericTextBox ID="txtDescuentoFinal" runat="server"  Width="100%" 
        ...
        <div class="fila">
            ...
            <div class="colum2">
                <telerik:RadTextBox ID="DescuentoMaximo" runat="server" style="visibility:hidden" Width="0%"></telerik:RadTextBox>
                <telerik:RadTextBox ID="DescuentoInicial" runat="server" style="visibility:hidden" Width="0%"></telerik:RadTextBox>
                <telerik:RadTextBox ID="DescuentoFinal" runat="server" style="visibility:hidden" Width="0%"></telerik:RadTextBox>
            </div>
        </div>
