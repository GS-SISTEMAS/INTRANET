...
{
    public partial class frmPresupuestoMarca : System.Web.UI.Page
    {
        ...
        private void Reporte_Cargar(int id_zonaV, string id_vendedorV)
        {
            ...
            if(chkExpandir.Checked) grdPresupuesto.RowGroupsDefaultExpanded = true;
            else grdPresupuesto.RowGroupsDefaultExpanded = false;

            List<gsPresupuesto_Reporte_MarcaResult> lstPresupuesto;
            try
            {
                ...
                lstPresupuesto = objReporteVenta.Presupuesto_Reporte_Marca(((Usuario_LoginResult)Session["Usuario"]).idEmpresa, ((Usuario_LoginResult)Session["Usuario"]).codigoUsuario, fechaInicio, fechaFinal, id_zona , id_vendedor).ToList();

                grdPresupuesto.DataSource = lstPresupuesto;
                grdPresupuesto.DataBind();

                lblMensaje.Text = "Se han encontrado " + lstPresupuesto.Count.ToString() + " registro.";
                lblMensaje.CssClass = "mensajeExito";

                ViewState["lstPresupuesto"] = JsonHelper.JsonSerializer(lstPresupuesto);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                grdPresupuesto.ExportSettings.FileName = "ReportePresupuestoMarca_" + DateTime.Now.ToString("yyyyMMddHmm");
