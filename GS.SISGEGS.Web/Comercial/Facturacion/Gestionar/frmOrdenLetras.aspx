<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPopUpML.Master" AutoEventWireup="true" CodeBehind="frmOrdenLetras.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Facturacion.Gestionar.frmOrdenLetras" %>
        ...
        <div class="fila">
            <div class="colum12">
                 <telerik:RadCalendar 
                     ...
                     AutoPostBack="true" 
                     MultiViewColumns="2"
                     MultiViewRows="2" RangeSelectionMode="OnKeyHold" 
                     EnableViewSelector="true" Height="50%" 
                     OnSelectionChanged="cdLetras_SelectionChanged" >
