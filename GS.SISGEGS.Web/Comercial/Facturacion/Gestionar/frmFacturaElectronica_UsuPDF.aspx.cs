...
{
    public partial class frmFacturaElectronica_UsuPDF : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string ObtenerPDFLetra(decimal Op, int Empresa)
        {
            ...
            listLetras = objLetrasWCF.LetrasElectronicas_Listar(Empresa, 1, Convert.ToInt32(Op.ToString())).ToList();

            byte[] Respuesta = CreatePDF_static(Empresa, 1, Op.ToString(), listLetras);

            return Convert.ToBase64String(Respuesta);
        }
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    //idempresa = int.Parse((Request.QueryString["idempresa"]));
                    //codusuario = int.Parse((Request.QueryString["codusuario"]));
                    //ExportarLetra_PDF(44462, idempresa, codusuario);
                }
            }
        ...
        private void ExportarLetra_PDF(decimal OpElectronica, int idempresa, int idusuario)
        {
            LetrasEmitidasWCFClient objLetrasWCF = new LetrasEmitidasWCFClient();
            List<gsLetrasElectronicas_ListarResult> listLetras = new List<gsLetrasElectronicas_ListarResult>();
            try
            {
                ...
                try
                {
                    ...
                    listLetras = objLetrasWCF.LetrasElectronicas_Listar(idempresa,
                    idusuario, Convert.ToInt32(OpElectronica.ToString())).ToList();
                    ...
                    if (listLetras.Count > 0)
                    {
                        ...
                        byte[] Respuesta = CreatePDF(idempresa, idusuario, OpElectronica.ToString(), listLetras);
        ...
        private static byte[] CreatePDF_static(int idEmpresa, int codUsuario, string Op, List<gsLetrasElectronicas_ListarResult> listLetras)
        {
            ...
            using (MemoryStream output = new MemoryStream())
            {
                ...
                doc.Open();
                doc.Add(Add_Content_To_PDF_static(tableLayout, idEmpresa, codUsuario, Op, listLetras));
        ...
        private static PdfPTable Add_Content_To_PDF_static(PdfPTable tableLayout, int idEmpresa, int codUsuario, string Op, List<gsLetrasElectronicas_ListarResult> listLetras)
        {
            string urlImagen;
            decimal OpInt = 0;
            ...
            iTextSharp.text.Image logo = iTextSharp.text.Image.GetInstance(ConfigurationSettings.AppSettings.Get("ImageGrupo"));
            ...
            tableLayout = ListaLetraElectronica_PDF_static(idEmpresa, codUsuario, tableLayout, Convert.ToInt32(OpInt), objEmpresa.razonSocial, listLetras);
        ...
        private PdfPTable Add_Content_To_PDF(PdfPTable tableLayout, int idEmpresa, int codUsuario, string Op, List<gsLetrasElectronicas_ListarResult> listLetras)
        {
            ...
            tableLayout = ListaLetraElectronica_PDF(idEmpresa, codUsuario, tableLayout, Convert.ToInt32(OpInt), objEmpresa.razonSocial, listLetras);


            return tableLayout;
        }

        private static PdfPTable ListaLetraElectronica_PDF_static(int idEmpresa, int codUsuario, PdfPTable PDFCreator, int idOperacion, string NombreEmpresa, List<gsLetrasElectronicas_ListarResult> listLetras)
        {
            ...
            try
            {
                if (idOperacion != 0)
                {
                    ...
                    foreach (gsLetrasElectronicas_ListarResult letra in listLetras.OrderBy(x => x.ID_Amarre))
                    {
                        ...
                        Letra = objLetrasWCF.LetrasElectronicas_Individual(idEmpresa, codUsuario, id_Amarre).ToList();
                        ...
                        foreach (VBG01425Result row in Letra)
                        {
                            ...
                            //    idEmpresa, codUsuario,
                            //    Convert.ToInt32(row.ID_Letra), "632"); //allan grey 
                            ...
                            {
                                logo = iTextSharp.text.Image.GetInstance(ConfigurationSettings.AppSettings.Get("ImageLogoSil"));
                            }
                            if (idEmpresa == 2)
                            {
                                logo = iTextSharp.text.Image.GetInstance(ConfigurationSettings.AppSettings.Get("ImageLogoNeo"));
                            }
                            if (idEmpresa == 6)
                            {
                                logo = iTextSharp.text.Image.GetInstance(ConfigurationSettings.AppSettings.Get("ImageLogoIna"));
                            }
                            ...
                            // Nivel 3
                            // fila 8
                            string ImporteLetras = enletras_static(row.Importe.ToString());
        ...
        private PdfPTable ListaLetraElectronica_PDF(int idEmpresa, int codUsuario, PdfPTable PDFCreator, int idOperacion, string NombreEmpresa, List<gsLetrasElectronicas_ListarResult> listLetras)
        {
            PdfPTable tableLayout;
            tableLayout = PDFCreator;
            LetrasEmitidasWCFClient objLetrasWCF = new LetrasEmitidasWCFClient();
                ...
                if (idOperacion != 0)
                {
                    ...
                    foreach (gsLetrasElectronicas_ListarResult letra in listLetras.OrderBy(x => x.ID_Amarre))
                    {
                        ...
                        foreach (VBG01425Result row in Letra)
                        {
                            ...
                            //objLetrasWCF.Registrar_LogLetrasDescargadas(
                            //    idEmpresa, codUsuario,
                            //    Convert.ToInt32(row.ID_Letra), "632",1); //allan grey 
        ...
        public static string enletras_static(string num)
        {
            string res, dec = "";
            Int64 entero;
            int decimales;
            ...
            res = toText_static(Convert.ToDouble(entero)) + dec;
            return res;
        }
        ...
        private static string toText_static(double value)
        {
            string Num2Text = "";
            ...
            else if (value < 20) Num2Text = "DIECI" + toText_static(value - 10);
            else if (value == 20) Num2Text = "VEINTE";
            else if (value < 30) Num2Text = "VEINTI" + toText_static(value - 20);
            ...
            else if (value < 100) Num2Text = toText_static(Math.Truncate(value / 10) * 10) + " Y " + toText_static(value % 10);
            else if (value == 100) Num2Text = "CIEN";
            else if (value < 200) Num2Text = "CIENTO " + toText_static(value - 100);
            else if ((value == 200) || (value == 300) || (value == 400) || (value == 600) || (value == 800)) Num2Text = toText_static(Math.Truncate(value / 100)) + "CIENTOS";
            else if (value == 500) Num2Text = "QUINIENTOS";
            else if (value == 700) Num2Text = "SETECIENTOS";
            else if (value == 900) Num2Text = "NOVECIENTOS";
            else if (value < 1000) Num2Text = toText_static(Math.Truncate(value / 100) * 100) + " " + toText_static(value % 100);
            else if (value == 1000) Num2Text = "MIL";
            else if (value < 2000) Num2Text = "MIL " + toText_static(value % 1000);
            else if (value < 1000000)
            {
                Num2Text = toText_static(Math.Truncate(value / 1000)) + " MIL";
                if ((value % 1000) > 0) Num2Text = Num2Text + " " + toText_static(value % 1000);
            }

            else if (value == 1000000) Num2Text = "UN MILLON";
            else if (value < 2000000) Num2Text = "UN MILLON " + toText_static(value % 1000000);
            else if (value < 1000000000000)
            {
                Num2Text = toText_static(Math.Truncate(value / 1000000)) + " MILLONES ";
                if ((value - Math.Truncate(value / 1000000) * 1000000) > 0) Num2Text = Num2Text + " " + toText_static(value - Math.Truncate(value / 1000000) * 1000000);
            }

            else if (value == 1000000000000) Num2Text = "UN BILLON";
            else if (value < 2000000000000) Num2Text = "UN BILLON " + toText_static(value - Math.Truncate(value / 1000000000000) * 1000000000000);

            else
            {
                Num2Text = toText_static(Math.Truncate(value / 1000000000000)) + " BILLONES";
                if ((value - Math.Truncate(value / 1000000000000) * 1000000000000) > 0) Num2Text = Num2Text + " " + toText_static(value - Math.Truncate(value / 1000000000000) * 1000000000000);
            }
            return Num2Text;
        ...
        private void ShowPdf(byte[] strS, string Nombre_PDF)
        {
            ...
            try
            {
                ...
                //byte[] bytesInStream = strS;// new byte[memoryStream.Length];
                //memoryStream.Write(bytesInStream, 0, bytesInStream.Length);
                //memoryStream.Close();
                //Response.Clear();
                //Response.ContentType = "application/force-download";
                //Response.AddHeader("content-disposition",
                //                   "attachment; filename=name_you_file.pdf");
