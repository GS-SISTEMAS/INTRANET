<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmSolDevolucionFacturacion.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Devoluciones.frmSolDevolucionFacturacion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Grupo Silvestre - Consultar solicitudes pendientes de generar NC
</asp:Content>
    ...
    <telerik:RadAjaxPanel ID="rapDevolucion" runat="server" Width="100%" Height="100%">
        <telerik:RadPageLayout ID="RadPageLayout1" runat="server" Width="100%" Height="100%">
            <Rows>
                <telerik:LayoutRow>
                    <Content>
                        <asp:Label ID="lblTitulo" runat="server" Text="Solicitudes de devolución pendientes de generar nota de crédito" CssClass="titulo"></asp:Label>
                    </Content>
                </telerik:LayoutRow>
                            ...
                            <telerik:RadPane ID="RadPane1" runat="server" Width="22px" Scrolling="None">
                                <telerik:RadSlidingZone ID="RadSlidingZone1" runat="server" Width="22px">
                                    <telerik:RadSlidingPane ID="RadSlidingPane1" runat="server" Width="250px" Title="Filtros de Busqueda" EnableDock="false"
                                        MinWidth="225" MinHeight="225" Scrolling="None" TabView="TextOnly">
                                        <div class="fila">
                                            <div class="colum3">
                                        ...
                                        <div class="fila">
                                            <div class="colum3">
                                                <asp:Label ID="lblNotaCred" runat="server" Text="Est.Nota Cred." CssClass="etiqueta"></asp:Label>
                                            </div>
                                            <div class="colum7">
                                                <telerik:RadComboBox ID="cboNotaCred" runat="server">
                                                    <Items>
