<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmSolDevolucionConsultar.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Devoluciones.frmSolDevolucionConsultar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Grupo Silvestre - Consultar solicitudes de devolución
</asp:Content>
    ...
    <telerik:RadAjaxPanel ID="rapDevolucion" runat="server" Width="100%" Height="100%">
        <telerik:RadPageLayout ID="RadPageLayout1" runat="server" Width="100%" Height="100%">
            <Rows>
                <telerik:LayoutRow>
                    <Content>
                        <asp:Label ID="lblTitulo" runat="server" Text="Gestionar solicitudes de devolución" CssClass="titulo"></asp:Label>
                    </Content>
                </telerik:LayoutRow>
                                ...
                                <telerik:RadPageLayout ID="RadPageLayout2" runat="server" Height="100%">
                                    <Rows>
                                        <telerik:LayoutRow Height="100%">
                                            <Content>
                                                <telerik:RadGrid ID="grdDevolucionSolicitud" runat="server" Width="100%" Height="100%" AutoGenerateColumns="false" AllowFilteringByColumn="True" OnItemDataBound="grdDevolucionSolicitud_ItemDataBound"
                                                    OnItemCommand="grdDevolucionSolicitud_ItemCommand" OnNeedDataSource="grdDevolucionSolicitud_NeedDataSource" OnDeleteCommand="grdDevolucionSolicitud_DeleteCommand">
                                                    ...
                                                    <MasterTableView DataKeyNames="idDevolucionSolicitud" ClientDataKeyNames="idDevolucionSolicitud">
                                                        <Columns>
                                                            <telerik:GridTemplateColumn HeaderText="Edit." AllowFiltering="false" UniqueName="Edit">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="ibDevolucion" runat="server" ToolTip="Editar" CommandName="Editar" 
                                                                        CommandArgument='<%# Eval("idDevolucionSolicitud") + "," + Eval("Op") %>' ImageUrl="~/Images/Icons/pencil-16.png" />
                                                                </ItemTemplate>
                                                           ...
                                                           <%-- <telerik:GridBoundColumn DataField="flete" HeaderText="Flete" UniqueName="flete" DataFormatString="${0:F2}" AllowFiltering="false">
                                                            ...
                                                            <telerik:GridBoundColumn DataField="Cantidad" HeaderText="Cant." UniqueName="Cantidad" AllowFiltering="false">
                                                                <HeaderStyle Width="150px" />
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn DataField="Importe" HeaderText="Imp." UniqueName="Importe" AllowFiltering="false">
                                                                <HeaderStyle Width="150px" />
                                                            </telerik:GridBoundColumn>
                                                            <%--<telerik:GridBoundColumn DataField="GuiadoDev" HeaderText="Guía" UniqueName="GuiadoDev" AllowFiltering="true" AutoPostBackOnFilter="false" CurrentFilterFunction="Contains" ShowFilterIcon="false" FilterDelay="2000">
                                                                <HeaderStyle Width="60px" />
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn DataField="NotaCredito" HeaderText="NotaCred." UniqueName="NotaCredito" AllowFiltering="true" AutoPostBackOnFilter="false" CurrentFilterFunction="Contains" ShowFilterIcon="false" FilterDelay="2000">
                                                                <HeaderStyle Width="60px" />
                                                            </telerik:GridBoundColumn>--%>
                                                            <telerik:GridCheckBoxColumn DataField="aprobacion1" HeaderText="Aprob." AllowFiltering="false" UniqueName="aprobacion1">
                                                                <HeaderStyle Width="30px"/>
                                                            </telerik:GridCheckBoxColumn>
                                                            <telerik:GridCheckBoxColumn DataField="GuiadoDev" HeaderText="Guía" AllowFiltering="false" UniqueName="GuiadoDev">
                                                                <HeaderStyle Width="30px"/>
                                                            </telerik:GridCheckBoxColumn>
                                                            <telerik:GridCheckBoxColumn DataField="NotaCredito" HeaderText="NotaCred." AllowFiltering="false" UniqueName="NotaCredito">
                                                                <HeaderStyle Width="30px"/>
                                                            </telerik:GridCheckBoxColumn>
