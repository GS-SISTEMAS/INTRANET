<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="Stock.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Consulta.Stock" %>
            ...
            <div class="col-md-12">
                <telerik:RadGrid ID="grdStock" runat="server" Width="100%" Height="500px"
                    ...
                    <MasterTableView>
                        ...
                        <Columns>
                            <telerik:GridBoundColumn HeaderText="No_Almacen" DataField="No_Almacen" HeaderStyle-Width="350px">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Descripcion" DataField="Descripcion" Display="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Stock (Físico)"  DataFormatString="{0:##,###0}" DataField="Stock" Aggregate="Sum"
                                ItemStyle-HorizontalAlign="Right"
                                >
                                  <FooterStyle HorizontalAlign="Right" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Stock (Disponible)"  DataFormatString="{0:##,###0}" DataField="StockDisponible" Aggregate="Sum"
                                ItemStyle-HorizontalAlign="Right"
                                >
                                  <FooterStyle HorizontalAlign="Right" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="U.M." DataField="UnidadControl">
                               ...
                               <telerik:GridBoundColumn HeaderText="PrecioBase" DataField="PrecioBase"   DataFormatString="{0:##,###0.##}" Aggregate="Avg"
                                   ItemStyle-HorizontalAlign="Right">
                                     <FooterStyle HorizontalAlign="Right" />
                            </telerik:GridBoundColumn>
                               <telerik:GridBoundColumn HeaderText="Descuento" DataField="DctoMaxBase"   DataFormatString="{0:##,###0.##}" Aggregate="Avg"
                                   ItemStyle-HorizontalAlign="Right">
                                     <FooterStyle HorizontalAlign="Right" />
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn HeaderText="Categoría" DataField="FamiliaKardexNiv02_Nombre" HeaderStyle-Width="350px">
                            </telerik:GridBoundColumn>
                        </Columns>
                    </MasterTableView>
