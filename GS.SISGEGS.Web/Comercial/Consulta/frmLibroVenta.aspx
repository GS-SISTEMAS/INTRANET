<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmLibroVenta.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Consulta.frmLibroVenta" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Grupo Silvestre - Consultar productos vendidos por cliente
</asp:Content>
                            ...
                            <telerik:RadPane ID="RadPane1" runat="server" Width="22px" Scrolling="None">
                                <telerik:RadSlidingZone ID="RadSlidingZone1" runat="server" Width="22px">
                                    <telerik:RadSlidingPane ID="RadSlidingPane1" runat="server" Width="250px" Title="Filtros de Busqueda" EnableDock="false" 
                                        ...
                                        <div class="fila">
                                            <div class="colum3">
                                                <asp:Label ID="lblFechaInicio" runat="server" Text="Fec.Inicio" CssClass="etiqueta"></asp:Label>
                                            </div>
                                            <div class="colum7">
                                                <telerik:RadDatePicker ID="dpFechaInicio" runat="server" Width="100%" DateInput-DateFormat="dd/MM/yyyy"></telerik:RadDatePicker>
                                            </div>
                                        </div>
                                        <div class="fila">
                                            <div class="colum3">
                                            ...
                                            <div class="colum7">
                                                <telerik:RadDatePicker ID="dpFechaFinal" runat="server" Width="100%" DateInput-DateFormat="dd/MM/yyyy"></telerik:RadDatePicker>
                                            </div>
                                        </div>
                                        <div class="fila">
                                            <div class="colum3">
                                                ...
                                                <telerik:RadGrid ID="grdProducto" runat="server" Width="100%" Height="100%" AutoGenerateColumns="false" 
                                                    ...
                                                    <MasterTableView ShowFooter="true" AllowFilteringByColumn="true">
                                                        <Columns>
                                                            ...
                                                            <telerik:GridBoundColumn DataField="Factura" HeaderText="Factura" UniqueName="Factura" AllowFiltering="false">
                                                                <HeaderStyle Width="80px"/>
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn DataField="Guia" HeaderText="Guia" UniqueName="Guia" AllowFiltering="false">
                                                                <HeaderStyle Width="80px"/>
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn DataField="FormaPago" HeaderText="FormaPago" UniqueName="FormaPago" CurrentFilterFunction="Contains" ShowFilterIcon="false" FilterDelay="2000">
                                                                <HeaderStyle Width="100px"/>
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn DataField="Documento" HeaderText="Documento" UniqueName="Documento" CurrentFilterFunction="Contains" ShowFilterIcon="false" FilterDelay="2000">
                                                                <HeaderStyle Width="100px"/>
                                                            </telerik:GridBoundColumn>
                                                            ...
                                                            <telerik:GridBoundColumn DataField="Descripcion" HeaderText="Descripcion" UniqueName="Descripcion" CurrentFilterFunction="Contains" ShowFilterIcon="false" FilterDelay="2000">
                                                                <HeaderStyle Width="150px"/>
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn DataField="Cantidad" HeaderText="Cantidad" UniqueName="Cantidad" DataFormatString="{0:F0}" Aggregate="Sum" AllowFiltering="false">
                                                                <HeaderStyle Width="80px"/>
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridCalculatedColumn DataFields="Cantidad, ValorVenta" HeaderText="Precio Unit." Expression="{1}/{0}" DataFormatString="${0:#,0.00}" AllowFiltering="false" UniqueName="PrecioUnit">
                                                                <HeaderStyle Width="80px"/>
