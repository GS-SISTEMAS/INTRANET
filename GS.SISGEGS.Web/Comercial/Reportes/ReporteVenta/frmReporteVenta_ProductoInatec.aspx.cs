...
{
    public partial class frmReporteVenta_ProductoInatec : System.Web.UI.Page
    {
        ...
        private void ReporteMarca_Cargar() {
            ...
            try {
                ...
                grdProducto.DataSource = objReporteVentaWCF.DocVenta_ReporteVenta_MarcaInatec(((Usuario_LoginResult)Session["Usuario"]).idEmpresa,
        ...
        protected void grdProducto_ItemDataBound(object sender, GridItemEventArgs e)
        {
            ...
            try
            {
                if (e.Item is GridFooterItem)
                {
                    ...
                    if(strValorPlanificado.Length > 0)
                    {
