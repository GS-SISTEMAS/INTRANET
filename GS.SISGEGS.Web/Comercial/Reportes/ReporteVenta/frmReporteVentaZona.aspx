<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmReporteVentaZona.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Reportes.ReporteVenta.frmReporteVentaZona" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <telerik:RadGrid ID="grdDocVenta" runat="server" AutoGenerateColumns="false" Width="100%" Height="500px" 
                                    OnNeedDataSource="grdDocVenta_NeedDataSource" OnItemCommand="grdDocVenta_ItemCommand" ShowFooter="true" GridLines="None" 
                                    ...
                                    <MasterTableView Height="100%" TableLayout="Fixed">
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn HeaderText="Pronostico" DataField="ValorPlanificado" DataFormatString="${0:#,0}" Aggregate="Sum">
                                                <HeaderStyle Width="80px"/>
                                                <FooterStyle Font-Bold="true"/>
                                            </telerik:GridBoundColumn>
...
<%--                                        <telerik:GridBoundColumn HeaderText="Costo Venta" DataField="CostoVenta" DataFormatString="${0:#,0}" Aggregate="Sum">
                                                <HeaderStyle Width="80px"/>
                                            </telerik:GridBoundColumn>--%>

                                            <telerik:GridBoundColumn HeaderText="Costo Venta<br>Real" DataField="CostoVentaReal" DataFormatString="${0:#,0}" Aggregate="Sum">
                                                <HeaderStyle Width="80px"/>
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn HeaderText="Rentab.<br>Real" DataField="Rentabilidad" DataFormatString="{0:F0}%">
                                                <HeaderStyle Width="80px"/>
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn HeaderText="Costo Venta<br>Calculado" DataField="CostoVentaCalculado" DataFormatString="${0:#,0}" Aggregate="Sum">
                                                <HeaderStyle Width="80px"/>
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn HeaderText="Rentab.<br>Calculado" DataField="RentabilidadCalculado" DataFormatString="{0:F0}%">
                                                <HeaderStyle Width="80px"/>
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn HeaderText="Costo Venta<br>Estandar" DataField="CostoVentaEstandar" DataFormatString="${0:#,0}" Aggregate="Sum">
                                                <HeaderStyle Width="80px"/>
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn HeaderText="Rentab.<br>Estandar" DataField="RentabilidadEstandar" DataFormatString="{0:F0}%">
                                                <HeaderStyle Width="80px"/>
                                            </telerik:GridBoundColumn>
                                            ...
                                            <%--                                            
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Graf.">
                                                <ItemTemplate>
                                                <asp:ImageButton ID="ibKPIs" runat="server" CommandArgument='<%# Eval("ID_Zona") %>' 
                                                CommandName="Grafico" ImageUrl="~/Images/Icons/analytics-16.png"/>
                                                </ItemTemplate>
                                                <HeaderStyle Width="40px"/>
                                                </telerik:GridTemplateColumn>
