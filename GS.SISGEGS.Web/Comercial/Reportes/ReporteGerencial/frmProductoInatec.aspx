<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmProductoInatec.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Reportes.ReporteGerencial.frmProductoInatec" %>
                                ...
                                <telerik:RadPane ID="RadPane2" runat="server" Width="100%" Scrolling="None" Height="100%">
                                    <telerik:RadPivotGrid ID="grdProducto" runat="server" Width="100%" Height="100%" AllowFiltering="false" ShowFilterHeaderZone="false"
                                        ...
                                        <Fields>
                                            ...
                                            <telerik:PivotGridRowField DataField="OpcionG5" ZoneIndex="1" >
                                                <CellStyle Width="250px"/>
                                            </telerik:PivotGridRowField>
