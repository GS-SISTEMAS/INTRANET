<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPopUpZona.Master" AutoEventWireup="true" CodeBehind="frmPersonalZonaMng.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Reportes.ReporteBI.Mantenedor.frmPersonalZonaMng" %>
    ...
    <telerik:RadAjaxPanel ID="rapEmpresaMng" runat="server" Width="100%">
        ...
        <div class="fila">
            ...
            <telerik:RadTabStrip runat="server" ID="stripPedido" MultiPageID="rmpRepEstadoCuenta" SelectedIndex="0" CssClass="col-md-12">
                <Tabs>
                    <telerik:RadTab Text="Zonas" Selected="True"></telerik:RadTab>
                    <telerik:RadTab Text="Unid. Negocio"></telerik:RadTab>
              ...
              <telerik:RadMultiPage runat="server" ID="rmpRepEstadoCuenta" SelectedIndex="0" Height="100%" CssClass="col-md-12">
                    <telerik:RadPageView runat="server" ID="pageResumen" CssClass="col-md-12" Height="100%" Width="100%"> 
                           <telerik:RadListBox ID="ltbZonas" runat="server" RenderMode="Lightweight" CheckBoxes="true" ShowCheckAll="true" Enabled="false"
                            Width="100%" Height="250px" DataTextField="Nombre" DataValueField="Id_Zona"></telerik:RadListBox>
                </telerik:RadPageView>
                    <telerik:RadPageView runat="server" ID="pageUnidad" CssClass="col-md-12" Height="100%" Width="100%"> 
                           <telerik:RadListBox ID="ltbUnidad" runat="server" RenderMode="Lightweight" CheckBoxes="true" ShowCheckAll="true" Enabled="false"
                            Width="100%" Height="250px" DataTextField="Nombre" DataValueField="id_unidad"></telerik:RadListBox>
                    </telerik:RadPageView>

                     <telerik:RadPageView runat="server" ID="pageReporte" CssClass="col-md-12" Height="100%" Width="100%"> 
                           <telerik:RadListBox ID="ltbReporte" runat="server" RenderMode="Lightweight" CheckBoxes="true" ShowCheckAll="true" Enabled="false"
                            Width="100%" Height="250px" DataTextField="Nombre" DataValueField="id_reporte"></telerik:RadListBox>
                    </telerik:RadPageView>
