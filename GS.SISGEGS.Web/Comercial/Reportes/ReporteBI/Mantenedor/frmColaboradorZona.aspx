<%@ Page Title="" Language="C#" MasterPageFile="~/Security/mstPage.Master" AutoEventWireup="true" CodeBehind="frmColaboradorZona.aspx.cs" Inherits="GS.SISGEGS.Web.Comercial.Reportes.ReporteBI.Mantenedor.frmColaboradorZona" %>
             ...
             <div class="row">
                ...
                <telerik:RadGrid 
                   ...
                   OnNeedDataSource="grdPersonal_NeedDataSource"
                    OnItemDataBound="grdPersonal_ItemDataBound"
                   AllowSorting="True" ShowFooter="true" >

                     <MasterTableView TableLayout="Fixed" DataKeyNames="idPermiso"  >

                        <Columns>
                            <telerik:GridTemplateColumn>
                                <ItemTemplate>
                                    <asp:ImageButton ID="ibEditar" runat="server" ImageUrl="~/Images/Icons/pencil-16.png" CommandArgument='<%# Eval("idPermiso") %>'  CommandName="Editar"/>
                                </ItemTemplate>
                ...
                <div class="col-md-3">
                      ...
                      >
                        <MasterTableView>
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="ID_Zona" HeaderText="ID_Zona" UniqueName="ID_Zona" Display="false" >
                                ...
                                <telerik:GridBoundColumn DataField="Zona" HeaderText="Zona" UniqueName="Zona" Aggregate="Count">
                                  ...
                                  <telerik:GridBoundColumn DataField="Estado" HeaderText="Estado" UniqueName="Estado" Display="false"  >
                                    <HeaderStyle Width="80px" />
                                </telerik:GridBoundColumn>
                 ...
                 <div class="col-md-2">
                 <telerik:RadGrid ID="grdUnidades" runat="server" AutoGenerateColumns="false" Width="100%"  Height="400px" 
                     OnItemCommand="grdUnidades_ItemCommand"  ShowFooter="true" AllowSorting="True" 
                     OnNeedDataSource="grdUnidades_NeedDataSource"
                      >
                        <MasterTableView>
                            <Columns>
                 ...
                 <div class="col-md-2">
                 <telerik:RadGrid ID="grdReporte" runat="server" AutoGenerateColumns="false" Width="100%"  Height="400px" 
                     OnItemCommand="grdReporte_ItemCommand"  ShowFooter="true" AllowSorting="True" 
                     OnNeedDataSource="grdReporte_NeedDataSource"
                      >
                        <MasterTableView>
                            <Columns>
