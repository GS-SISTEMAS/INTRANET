...
namespace GS.SISGEGS.WINStock.ImpuestoWCF {
    ...
    public interface IImpuestoWCF {
        ...
        GS.SISGEGS.WINStock.ImpuestoWCF.gsImpuesto_ListarPorItemResult[] Impuesto_ListarPorItem(int idEmpresa, int codigoUsuario, string idItem, System.DateTime fecha);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IImpuestoWCF/Impuesto_ListarPorItem", ReplyAction="http://tempuri.org/IImpuestoWCF/Impuesto_ListarPorItemResponse")]
        System.Threading.Tasks.Task<GS.SISGEGS.WINStock.ImpuestoWCF.gsImpuesto_ListarPorItemResult[]> Impuesto_ListarPorItemAsync(int idEmpresa, int codigoUsuario, string idItem, System.DateTime fecha);
        ...
        GS.SISGEGS.WINStock.ImpuestoWCF.gsImpuesto_BuscarPorPedidoResult[] Impuesto_BuscarPorPedido(int idEmpresa, int codigoUsuario, int idPedido);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IImpuestoWCF/Impuesto_BuscarPorPedido", ReplyAction="http://tempuri.org/IImpuestoWCF/Impuesto_BuscarPorPedidoResponse")]
        System.Threading.Tasks.Task<GS.SISGEGS.WINStock.ImpuestoWCF.gsImpuesto_BuscarPorPedidoResult[]> Impuesto_BuscarPorPedidoAsync(int idEmpresa, int codigoUsuario, int idPedido);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IImpuestoWCFChannel : GS.SISGEGS.WINStock.ImpuestoWCF.IImpuestoWCF, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ImpuestoWCFClient : System.ServiceModel.ClientBase<GS.SISGEGS.WINStock.ImpuestoWCF.IImpuestoWCF>, GS.SISGEGS.WINStock.ImpuestoWCF.IImpuestoWCF {
        ...
        public GS.SISGEGS.WINStock.ImpuestoWCF.gsImpuesto_ListarPorItemResult[] Impuesto_ListarPorItem(int idEmpresa, int codigoUsuario, string idItem, System.DateTime fecha) {
            return base.Channel.Impuesto_ListarPorItem(idEmpresa, codigoUsuario, idItem, fecha);
        }
        
        public System.Threading.Tasks.Task<GS.SISGEGS.WINStock.ImpuestoWCF.gsImpuesto_ListarPorItemResult[]> Impuesto_ListarPorItemAsync(int idEmpresa, int codigoUsuario, string idItem, System.DateTime fecha) {
            return base.Channel.Impuesto_ListarPorItemAsync(idEmpresa, codigoUsuario, idItem, fecha);
        }
        
        public GS.SISGEGS.WINStock.ImpuestoWCF.gsImpuesto_BuscarPorPedidoResult[] Impuesto_BuscarPorPedido(int idEmpresa, int codigoUsuario, int idPedido) {
            return base.Channel.Impuesto_BuscarPorPedido(idEmpresa, codigoUsuario, idPedido);
        }
        
        public System.Threading.Tasks.Task<GS.SISGEGS.WINStock.ImpuestoWCF.gsImpuesto_BuscarPorPedidoResult[]> Impuesto_BuscarPorPedidoAsync(int idEmpresa, int codigoUsuario, int idPedido) {
